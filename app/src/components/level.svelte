<div class="container my-5 text-center row mx-auto" id="levels">
    <div class="feature col">
        ...
        <h3 class="fs-2 text-body-emphasis">Level Name</h3>
        <p>{level_name}</p>
    </div>
    <div class="feature col">
        <div class="feature-icon d-inline-flex align-items-center justify-content-center fs-2 mb-3">
        ...
        <h3 class="fs-2 text-body-emphasis">Creator</h3>
        <p>{creator}</p>
    </div>
    <div class="feature col">
        <div class="feature-icon d-inline-flex align-items-center justify-content-center fs-2 mb-3">
...
<script>
export let level_name, creator, id;
</script>